...
import com.foodapp.CustomerFoodPanel.CustomerCartFragment;
import com.foodapp.CustomerFoodPanel.CustomerHomeFragment;
import com.foodapp.CustomerFoodPanel.CustomerOrderFragment;
import com.foodapp.CustomerFoodPanel.CustomerProfileFragment;
import com.foodapp.CustomerFoodPanel.CustomerTrackFragment;
...
//        FirebaseDatabase.getInstance().getReference("Tokens").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(token);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        return loadFragment(fragment); // Load the selected fragment
    }
