...
import com.foodapp.ReusableCode.ReusableCodeForAll;
...
public class Registeration extends AppCompatActivity {
    ...
    String[] Kathmandu = {"Basundhara", "Banasthali", "Budhanilkantha"};
    String[] Bhaktapur = {"Thimi", "jagati", "suryabinayk"};


    String[] Basundhara = {"tokha", "chkrapath", "samakhusi"
    };


    String[] Banasthali = {"banasthali", "kharibol", " dhungedhara", "raniban"};
    String[] Budhanilkantha = {"budhanikantha", "mandikhatar", "hattigauda", "golfutar"};
    String[] Gausala={"pingalastan","bijaychowk"};
    String[] Koteshwor={"balkumari","tinkune chowk"};
        ...
        try {
            ...
            statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (statee.equals("Kathmandu")) {
                        ArrayList<String> list = new ArrayList<>();
                        for (String text : Kathmandu) {
                            list.add(text);
                        }
                    ...
                    if (statee.equals("Bhaktapur")) {
                        ArrayList<String> list = new ArrayList<>();
                        for (String text : Bhaktapur) {
                            list.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, list);
            ...
            City.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (cityy.equals("Basundhara")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Basundhara) {
                            listt.add(text);
                        }
                    ...
                    if (cityy.equals("Banasthali")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Banasthali) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
                    ...
                    if (cityy.equals("Budhanilkantha")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Budhanilkantha) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
                    ...
                    if (cityy.equals("Gausla")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Gausala) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
                    }
                    if (cityy.equals("Koteshwor")) {
                        ArrayList<String> listt = new ArrayList<>();
                        for (String text : Koteshwor) {
                            listt.add(text);
                        }
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Registeration.this, android.R.layout.simple_spinner_item, listt);
                        Suburban.setAdapter(arrayAdapter);
